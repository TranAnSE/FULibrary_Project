        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShelfLocations_Libraries_LibraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LibraryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaxBooksPerBorrower = table.Column<int>(type: "int", nullable: false),
                    LoanDurationDays = table.Column<int>(type: "int", nullable: false),
                    MaxRenewals = table.Column<int>(type: "int", nullable: false),
                    RenewalDays = table.Column<int>(type: "int", nullable: false),
                    DailyFineRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LostBookFinePercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemSettings_Libraries_LibraryId",
                        column: x => x.LibraryId,
                        principalTable: "Libraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardIssuedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CardExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MustChangePassword = table.Column<bool>(type: "bit", nullable: false),
                    IsLocked = table.Column<bool>(type: "bit", nullable: false),
                    HomeLibraryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AssignedLibraryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Libraries_AssignedLibraryId",
                        column: x => x.AssignedLibraryId,
                        principalTable: "Libraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Libraries_HomeLibraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPurchaseSuggestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookPurchaseSuggestions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCopies_RegistrationNumber",
                table: "BookCopies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPurchaseSuggestions_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShelfLocations_LibraryId",
                table: "ShelfLocations",
                column: "LibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_SystemSettings_LibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AssignedLibraryId",
                table: "Users",
                column: "AssignedLibraryId");
